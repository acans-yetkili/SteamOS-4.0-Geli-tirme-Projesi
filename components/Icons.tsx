...
export const SteamLogo = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M11.99 0C5.37 0 0 5.38 0 12c0 3.04 1.13 5.84 3.02 8.01l5.01-2.07c-.01-.15-.02-.31-.02-.46 0-3.67 2.98-6.65 6.65-6.65 3.67 0 6.65 2.98 6.65 6.65 0 3.67-2.98 6.65-6.65 6.65-.87 0-1.7-.16-2.48-.46l-2.64 6.13a11.99 11.99 0 0 0 2.47.33c6.62 0 11.99-5.37 11.99-11.99S18.61 0 11.99 0zm2.66 12.32l-3.62 1.5c-.35-.15-.74-.23-1.14-.23-1.65 0-2.98 1.33-2.98 2.98 0 1.65 1.33 2.98 2.98 2.98 1.48 0 2.71-1.07 2.93-2.48l1.83-1.77z m1.31 1.66c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z"/>
  </svg>
);
...
export const SparklesIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M9 5H1"/><path d="M19 18v3"/><path d="M16 19.5h6"/></svg>
);
...
export const BatteryIcon = ({ level, className }: { level: number, className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <rect x="4" y="9" width={12 * (level/100)} height="6" fill="currentColor" stroke="none" />
  </svg>
);

export const WifiIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 20h.01"/><path d="M2 8.82a15 15 0 0 1 20 0"/><path d="M5 12.859a10 10 0 0 1 14 0"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/></svg>
);
